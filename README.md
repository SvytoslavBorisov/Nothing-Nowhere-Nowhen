...
<p>Посмотреть приложение в работе nothing-nowhere-nowhen.ru</p>
<p>Пароль от админки LOGIN admin PASSWORD admin. Админку лучше пробовать в локальной сети, кто то из уже проверявших, может лишить ее прав админа. </p>
