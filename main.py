...
#     8. Рендеринг
# '''
# @app.route('/game/<int:id_>', methods=['POST', 'GET'])  # 4
# def game(id_):
#     if return_to_game():                    # 1
#         return redirect('/current_game')    # 2
#
...
# '''
# @app.route('/start_game/<int:id_>+<int:comp_>+<type>', methods=['POST', 'GET'])
# @login_required
...
#     3. Рендеринг
# '''
# @app.route('/end_game/<why>+<int:add_rating>')
# @login_required
...
# '''
# @app.route('/check_quests', methods=['POST', 'GET'])
# @login_required
# def check_quests():
#     if return_to_game():                      # 1
#         return redirect('/current_game')      # 1
...
#     6. Рендеринг
# '''
# @app.route('/admin_add_news/', methods=['POST', 'GET'])
# @login_required
# def admin_add_news():
#     if current_user.is_authenticated and current_user.state == 'admin':                   # 1
#
...
# '''
# @app.route('/check_edit_or_show_quest/<id_>', methods=['POST', 'PUT', 'GET', 'DELETE'])
# @login_required
...
#     Вызов этих страниц происходит в коде html (js)
# '''
# @app.route('/check_edit_news/<id_>', methods=['POST', 'PUT', 'GET', 'DELETE'])
# @login_required
